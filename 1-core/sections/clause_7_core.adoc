...
Metadata : identifier: string[0..1]
...
Symbolizer : visibility: bool[0..1]
Symbolizer : opacity: float[0..1]
Symbolizer : zOrder: integer[0..1]
...
| identifier   | An identifier to reference the style | string              | 0..1
...
| metadata     | Container for descriptive information about a style | Metadata | 0..1
|===
