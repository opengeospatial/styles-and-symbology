...
This requirements class extends Fill capabilities by adding support for stipple fills with a point-based pattern.

.Fill class extended for stipples
[width="90%",options="header"]
|===
| Name           | Definition       | Type         | Multiplicity
| stipple   | Point-based pattern fill    | Stipple | 0..1
|===
