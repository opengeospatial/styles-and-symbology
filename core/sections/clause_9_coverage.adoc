...
=== Requirements Class "Coverage to Feature transformation"
...
//TODO: include::../requirements/rc-coverage-to-feature.adoc[]
...
class ContrastEnhancement <<enumeration>>
...
=== Requirements Class "Hue, Saturation, Lightness Modifier" 

==== Overview

[#img-uml-class-hslModifier]
.Symbolizer class UML Diagram (extended HSL modifier)
[plantuml, target=diagram-classes, format=png]
....
class Symbolizer <<extended>>
...
class HSLModifier
HSLModifier : hue: double
HSLModifier : saturation: double
HSLModifier : lightness: double
....

.HSL modifier Symbolizer properties
[width="90%",options="header"]
|===
| Name               | Definition	                                                 | Data type and value   | Multiplicity
| hslModifier        | Hue, Saturation, Lightness modifier to apply to the coverage  | HSLModifier           | 0..1
|===

.HSLModifier properties
[width="90%",options="header"]
|===
| Name               | Definition	                                  | Data type and value   | Multiplicity
...
| lightness          | Lightness modifier to apply to the coverage (multiplication factor)    | double                | 0..1
|===

==== Requirements

//TODO: include::../requirements/rc-hsl-modifiers.adoc[]