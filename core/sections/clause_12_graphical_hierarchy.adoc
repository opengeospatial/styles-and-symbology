...
....
Transform2D --* FloatPoint
Transform2D : orientation: Angle
Transform2D : scaling: FloatPoint
Transform2D : translation: FloatPoint
...
This requirements class removes the restriction on MultiGrahics containing other MultiGraphics.
...
| scaling      | Scaling              | FloatPoint    | 1
| translation  | Translation          | FloatPoint    | 1
|===
