...
....
class Stroke <<extended>>
Stroke : dashArray: array [0..1]
Stroke : dashOffset: numeric [0..1]
Stroke --* dashArray
Stroke --* dashOffset

class dashArray: array
class dashOffset: numeric
....
...
|===
| Name          | Definition         | Type         | Multiplicity
| dashArray     | Dash array         | array        | 0..1
| dashOffset    | Dash offset        | float or percent  | 0..1
|===
