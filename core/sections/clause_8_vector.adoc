...
include::../UML/PlantUML/adoc/vectorFeaturesSymbolizer.adoc[]
...
include::../UML/PlantUML/adoc/fill.adoc[]
...
.UML Class Diagram of the Symbology Stroke
include::../UML/PlantUML/adoc/stroke.adoc[]
...
[#img-uml-class-graphics]
.UML Class Diagram of the Symbology Graphics
include::../UML/PlantUML/adoc/graphics.adoc[]
