...
[#img-uml-class-viz-pass]
.viz.pass class UML Diagram
[plantuml, target=diagram-classes, format=png]
....
class viz.pass <<extended>>
viz.pass : viz.pass: int
....
...
| viz.pass | viz.pass value   | int    | 1
|===

// an example encoding of viz.pass and portayal might be added here

==== sortByGroup

[#img-uml-class-sortByGroup]
.sortByGroup class UML Diagram
[plantuml, target=diagram-classes, format=png]
....
class sortByGroup <<extended>>
sortByGroup : sortByGroup: string
....

.CCSSS Example showcasing the combination of vizPass and sortByGroup
====
[source,ccsss]
----
{
   #railways and bridge = 1 
   {
    stroke: #333333;
    stroke-width: 8;
    z-index: 0;
...
.Example rendering of viz.pass and sortByGroup
image::figures/roads-group.png[]

// Add another use case or mention GeoServer in the credits: https://docs.geoserver.org/2.23.x/en/user/styling/sld/extensions/z-order/example.html
...
|===
| Name   | Definition       | Type   | Multiplicity
| h       | Hue component   | float  | 1
| s       | Saturation component | float  | 1
| l       | Lightness component  | float  | 1
|===
...
and applies wherever this basic RGB or HSL Color class is used.

==== Gamma

[#img-uml-class-gamma]
.Gamma class UML Diagram
[plantuml, target=diagram-classes, format=png]
....
...
|===
| Name       | Definition              | Type   | Multiplicity
| gamma      | Gamma value             | float  | 1
|===

The Gamma class is used to define the gamma correction value to be applied to the color of a Fill or Stroke.
